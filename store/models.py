...
class Products(models.Model):
    ...
    image1_url = models.CharField(null=False, blank=False, default="")
    image2_url = models.CharField(null=True, blank=True)
    image3_url = models.CharField(null=True, blank=True)
